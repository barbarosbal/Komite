...
Bir sonuç raporu aşağıdaki alanları, ifşa politikasının izin verdiği ayrıntıda taşır:
...
- Kabul/ret/çekimser paylarının paydası: geçerli bildirilen tercihler. Yanıt vermeme çekimser sayılmaz; isteğe bağlı tavsiye kendi paydasıyla raporlanır.
- Katılım, eksik/başarısız bildirim ve veri kalitesi belirsizliği; sayılar ifşa riski taşıyorsa aralıklandırılır veya bastırılır.
- Bastırılan alanlar ve güvenli düzeyde gerekçesi; eksik değerler sıfır olarak gösterilmez.
- Sonucun temsiliyet sınırı, bütünlük kontrolünün kapsamı ve karar sahibinin ayrı nihai gerekçesi.
...
Uygunluk ihlali, manipüle içerik, bütünlük belirsizliği veya güvenli ifşa politikasının yokluğu turu/sonuç yayınını durdurur. İptal veya yeniden tur gerekçesi kaydedilir; “güvensiz ama yararlı” diyerek ham veriler açılmaz. Kanıt, katılımcı mahremiyetini ihlal etmeden saklanmalıdır; süre ve erişim politikası gerçek kullanım öncesi zorunludur.
