...
Kamusal araştırma, kimlik/tercih eşleştirmeleri veya sömürülebilir açık ayrıntıları içermemelidir. Güvenlik bildirimi için [SECURITY.md](SECURITY.md); katkı için [CONTRIBUTING.md](CONTRIBUTING.md).
